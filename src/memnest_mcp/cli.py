...
_PERSIST_PROMPT = (
    ...
    "   - the new memory corrects/updates something already stored -> "
    "memory_relate {\"from_id\": <new_id>, \"to_id\": <old_id>, "
    "\"relationship\": \"SUPERSEDES\"} (so the old version stops competing "
